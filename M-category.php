            ...
            <table class="tbl-full">
                ...
                ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo SITEURL; ?>update-category.php?id= <?php echo $id; ?>" class="btn-secondary">Update</a>
                                    <a href="<?php echo SITEURL; ?>useable/delete-category.php?id= <?php echo $id; ?>" class="btn-danger">Delete</a>
                                </td>
                            </tr>
